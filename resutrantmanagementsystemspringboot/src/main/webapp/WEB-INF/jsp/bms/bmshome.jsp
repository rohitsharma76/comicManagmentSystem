            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <form action="#" method="get">
                        <input type="search" name="fancySearch" id="search" placeholder="|search your comics by name/publication house/artists">
                        ...
                        <div class="collapse navbar-collapse" id="fancyNav">
                            <ul class="navbar-nav ml-auto">
                                <li class="nav-item active">
                                    <a class="nav-link" href="/bms/bmshome">Home <span class="sr-only">(current)</span></a>
                                </li>
                                 <li class="nav-item">
                                    <a class="nav-link" href="#">Add Comics</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="static-page.html">Search Comics</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="#">View your collection</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="contact.html">Admin Section</a>
                                </li>
                            </ul>
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="fancy-hero-content text-center">
                        ...
                        <a href="#" class="btn fancy-btn fancy-active">Add Comics </a>
                        <a href="#" class="btn fancy-btn">View Comics</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6 col-xl-5 ml-xl-auto">
                    <div class="about-us-thumb wow fadeInUp" data-wow-delay="0.5s">
                        <img src="../../images/bg-img/about-1.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
