...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="site-blocks-cover inner-page-cover overlay" style="background-image: url(../../listing/images/hero_1.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
          ...
          <div class="col-lg-8">
            ...
            <div class="mb-4">
              <div class="slide-one-item home-slider owl-carousel">
                <div><img src="../../listing/images/img_1.jpg" alt="Image" class="img-fluid"></div>
                <div><img src="../../listing/images/img_2.jpg" alt="Image" class="img-fluid"></div>
                <div><img src="../../listing/images/img_3.jpg" alt="Image" class="img-fluid"></div>
                <div><img src="../../listing/images/img_4.jpg" alt="Image" class="img-fluid"></div>
              </div>
            </div>
        ...
        <div class="row mt-5">
          <div class="col-lg-6">
            ...
            <div class="d-block d-md-flex listing">
              <a href="#" class="img d-block" style="background-image: url('../../listing/images/img_2.jpg')"></a>
            ...
            <div class="d-block d-md-flex listing">
                <a href="#" class="img d-block" style="background-image: url('../../listing/images/img_3.jpg')"></a>
                <div class="lh-content">
              ...
              <div class="d-block d-md-flex listing">
                <a href="#" class="img d-block" style="background-image: url('../../listing/images/img_4.jpg')"></a>
                <div class="lh-content">
          ...
          <div class="col-lg-6">
            ...
            <div class="d-block d-md-flex listing">
              <a href="#" class="img d-block" style="background-image: url('../../listing/images/img_1.jpg')"></a>
              <div class="lh-content">
        ...
        <div class="slide-one-item home-slider owl-carousel">
          <div>
            <div class="testimonial">
              <figure class="mb-4">
                <img src="../../listing/images/person_3.jpg" alt="Image" class="img-fluid mb-3">
                <p>John Smith</p>
              </figure>
              <blockquote>
          ...
          <div>
            <div class="testimonial">
              <figure class="mb-4">
                <img src="../../listing/images/person_2.jpg" alt="Image" class="img-fluid mb-3">
          ...
          <div>
            <div class="testimonial">
              <figure class="mb-4">
                <img src="../../listing/images/person_4.jpg" alt="Image" class="img-fluid mb-3">
                <p>Robert Spears</p>
              </figure>
              <blockquote>
                <p>&ldquo;Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur unde reprehenderit aperiam quaerat fugiat repudiandae explicabo animi minima fuga beatae illum eligendi incidunt consequatur. Amet dolores excepturi earum unde iusto.&rdquo;</p>
          ...
          <div>
            <div class="testimonial">
              <figure class="mb-4">
                <img src="../../listing/images/person_5.jpg" alt="Image" class="img-fluid mb-3">
                <p>Bruce Rogers</p>
              </figure>
              <blockquote>
                <p>&ldquo;Lorem ipsum dolor sit amet consectetur adipisicing elit. Consectetur unde reprehenderit aperiam quaerat fugiat repudiandae explicabo animi minima fuga beatae illum eligendi incidunt consequatur. Amet dolores excepturi earum unde iusto.&rdquo;</p>
